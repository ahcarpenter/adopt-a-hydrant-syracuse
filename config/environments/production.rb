...
AdoptAThing::Application.configure do
  ...
  config.action_controller.asset_host = Proc.new { |source| source.include?('Firefox') ? 'http://adopt-a-hydrant-syracuse.herokuapp.com' : 'https://d1f2hg8y6iibwb.cloudfront.net' }
end
